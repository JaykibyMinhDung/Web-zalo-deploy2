  ...
  return (
    <main className=" w-full h-full">
      <div
        ...
        // top-64
        className="absolute left-0 md:left-24 lg:left-20% 2xl:left-96 top-33vh md:top-2/4 w-full md:w-4/5 lg:w-3/5 h-60 rounded-3xl bg-white font-sans"
      >
        {/* Menu */}
        <div className="flex flex-nowrap justify-between text-center mx-3 ml-4 md:mx-8 mt-8">
          <NavLink to="#">
            <span className="inline-flex items-center rounded-full border-0 px-2 py-1 text-xs font-medium text-orange-navbar ring-1 ring-inset ring-red-600/10">
              {/* bg-red-50 */}
              <CartIcon className="w-7 sm:w-14" style={{ color: "#f67227" }} />
            </span>
