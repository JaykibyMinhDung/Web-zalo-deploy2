...
const HeaderMenu = () => {
  return (
    <div className=" w-full h-full">
      <div className="absolute left-6 md:left-24 lg:left-20% 2xl:left-96 top-36 md:top-52 w-90% md:w-4/5 lg:w-3/5 h-48 md:h-60 drop-shadow-6xl rounded-3xl bg-white z-10">
        <input
          type="text"
